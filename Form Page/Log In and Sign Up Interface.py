...
def open_role_form(role):
    ...
    # Left panel for navigation and instructions
    left_panel = tk.Frame(main_container, width=250, bg="#a0a0a0")
...
def create_background(parent):
    ...
    try:
        ...
        bg_image = bg_image.resize((parent.winfo_screenwidth() - 250, parent.winfo_screenheight()))
